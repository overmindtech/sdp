...
```golang
import overmind "github.com/overmindtech/api-server-go/overmind"
```
...
------------ | ------------- | ------------- | -------------
*BookmarksApi* | [**BookmarksList**](docs/BookmarksApi.md#bookmarkslist) | **Post** /gateway/v1/bookmarks | 


## Documentation For Models

 - [BookmarkDescriptor](docs/BookmarkDescriptor.md)
 - [BookmarkListResult](docs/BookmarkListResult.md)
